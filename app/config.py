...
COMPANY_RESEARCH_MODEL = env_str("COMPANY_RESEARCH_MODEL", CHAT_MODEL)
...
THESIS_MAX_EVIDENCE = env_int("THESIS_MAX_EVIDENCE", 50)
THESIS_WEB_FETCH_TIMEOUT = env_int("THESIS_WEB_FETCH_TIMEOUT", 20)
THESIS_WEB_CONTENT_WORDS = env_int("THESIS_WEB_CONTENT_WORDS", 5000)
THESIS_MAX_EVIDENCE_REUSE = env_int("THESIS_MAX_EVIDENCE_REUSE", 3)
